...
void MX_GPIO_Init(void)
{
  ...
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;    // Для подсветки хватит
  ...
  /*Configure GPIO pins : BTN_UP_Pin BTN_DN_Pin BTN_SEL_Pin */
  GPIO_InitStruct.Pin = BTN_UP_Pin|BTN_DN_Pin|BTN_SEL_Pin;
